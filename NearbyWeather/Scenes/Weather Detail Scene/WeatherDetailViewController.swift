...
final class WeatherDetailViewController: UIViewController, Stepper {
  ...
  @IBOutlet weak var conditionSymbolImageView: UIImageView!
  ...
  private func configure() {
    ...
    let image = ConversionWorker.weatherConditionSymbol(from: weatherDTO.weatherCondition[safe: 0]?.conditionIconCode)
    conditionSymbolImageView.image = image
